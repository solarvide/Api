    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 6, 18, 13, 46, 54, 43, DateTimeKind.Local).AddTicks(6658), false, "Monofásico", 30, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2L, new DateTime(2023, 6, 18, 13, 46, 54, 43, DateTimeKind.Local).AddTicks(6659), false, "Bifásico", 50, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3L, new DateTime(2023, 6, 18, 13, 46, 54, 43, DateTimeKind.Local).AddTicks(6660), false, "Trifásico", 100, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4L, new DateTime(2023, 6, 18, 13, 46, 54, 43, DateTimeKind.Local).AddTicks(6661), false, "A4", 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "SADM", new DateTime(2023, 6, 18, 13, 46, 54, 43, DateTimeKind.Local).AddTicks(6625), false, "Super Admin", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2L, "RP", new DateTime(2023, 6, 18, 13, 46, 54, 43, DateTimeKind.Local).AddTicks(6627), false, "Representante", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3L, "ADMF", new DateTime(2023, 6, 18, 13, 46, 54, 43, DateTimeKind.Local).AddTicks(6628), false, "Administrador Filial", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
